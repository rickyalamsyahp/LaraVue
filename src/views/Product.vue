...
import HeaderSalsa from '@/components/HeaderSalsa.vue'
import RelatedSalsa from '@/components/RelatedSalsa.vue'
import FooterSalsa from '@/components/FooterSalsa.vue'
